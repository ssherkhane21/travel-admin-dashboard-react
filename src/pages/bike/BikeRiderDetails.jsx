...
const riderData = {
  ...
  name: 'Alex Rodriguez',
  age: 28,
  address: '456 Rider Lane, Bike City, BC 54321',
  experience: 3,
...
const BikeRiderDetails = () => {
  ...
  const isNew = id === 'new';
  const [formData, setFormData] = useState(isNew ? { vehiclePhotos: [] } : riderData);
  ...
  const handleSubmit = (e) => {
    ...
    navigate('/bike/riders');
  };
  
  return (
    <div>
      <PageHeader
        title={isNew ? 'Add Bike Rider' : 'Bike Rider Details'}
        description={isNew ? 'Create a new bike rider' : 'View and edit bike rider details'}
        action={
          <button 
            onClick={() => navigate('/bike/riders')}
      ...
      <div className="bg-white rounded-lg shadow-sm border p-6">
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            {/* Riding Experience */}
            <div className="col-span-1">
              <label htmlFor="experience" className="block text-sm font-medium text-gray-700">Riding Experience (Years)</label>
              <input
                type="number"
                id="experience"
                name="experience"
